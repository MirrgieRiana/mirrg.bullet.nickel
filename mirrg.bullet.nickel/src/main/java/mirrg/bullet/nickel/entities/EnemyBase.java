...
public class EnemyBase implements ILiving
{
	...
	public ArrayList<InstanceWeapon> weapons = new ArrayList<>();
	...
	{
		this.weapons.add(new InstanceWeapon(weapons, false));
		return this;
	}
	...
	public boolean move(PhaseBattle phase)
	{
		...
		if (firing) {
			for (InstanceWeapon weapon : weapons) {
				weapon.shoot(this, phase);
			}
		}
		for (InstanceWeapon weapon : weapons) {
			weapon.move(this, phase);
		}
